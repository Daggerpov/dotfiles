...
Kickstart Guide:
  ...
  TODO: Tutor progress: being tracked in base dir using `nvim tutor`
...

    {
      ...
      config = function()
        require('gruvbox').setup {
          -- Optional: set background (dark/light), italics, etc.
          background = 'dark', -- or "light"
          italic = { comments = true, strings = true, keywords = true },
